...
public class CreateStudentDB {
    public static void main(String[] args) {
		...
		try {
			...
			//AA: added a float field example: gpa
			String s = "create table STUDENT(SId int, SName varchar(10), MajorId int, GradYear int, GPA float)";
			stmt.executeUpdate(s);
			System.out.println("Table STUDENT created.");

			s = "insert into STUDENT(SId, SName, MajorId, GradYear, GPA) values ";
			//AA: added gpa vals
			String[] studvals = {"(1, 'joe', 10, 2004, 3.5)",
								 "(2, 'amy', 20, 2004, 3.9)",
								 "(3, 'max', 10, 2005, 2.1)",
								 "(4, 'sue', 20, 2005, 3.9)",
								 "(5, 'bob', 30, 2003, 2.5)",
