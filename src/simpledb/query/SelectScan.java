...
public class SelectScan implements UpdateScan {
   ...
   public ArrayList<RID> getRidL(){
       return ((ProductScan) s).getRid();
   }
   public ArrayList<RecordFile> getRecordFileL(){
       return ((ProductScan) s).getRecordFile();
   }
   public RecordFile getRecordFile() {
       UpdateScan us = (UpdateScan) s;
       return us.getRecordFile();
   }
}
